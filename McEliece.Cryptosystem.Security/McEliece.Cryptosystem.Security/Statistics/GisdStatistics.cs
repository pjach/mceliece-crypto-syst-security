...
{
    public class GisdStatistics : IStatistics
    {
        private readonly ILogger _logger;

        public GisdStatistics(ILogger logger)
        {
            _logger = logger;
        }
        ...
        {
            var statisticsList = JsonConvert.DeserializeObject<List<GisdAttackStatisticsEntry>>(data);
